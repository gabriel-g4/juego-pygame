...
rana = Rana(200, PISO, 2, 2, fuente, jugador)
...
while on:
    ...
    #for corazon in range(jugador.vida):
    #    screen.blit(icono_corazones, (x_corazones, 0))
    #    x_corazones += 40
    #x_corazones = 100
    #screen.blit(barra_cuchillo, (110, 40))
    for vida in range(jugador.vida):
        screen.blit(cuadrado_vida, (x_corazones, 24))
        x_corazones += 32
    x_corazones = 60 + 115 - 30
    ...
    if debug_mode:
        ...
        screen.blit(fuente.render(str(rana.rect.x), True, COLORES.YELLOW1), (110, 140))
        screen.blit(fuente.render(str(rana.rect.y), True, COLORES.YELLOW1), (110, 170))
        screen.blit(fuente.render(str(rana.rect.w), True, COLORES.YELLOW1), (110, 200))
        screen.blit(fuente.render(str(rana.rect.h), True, COLORES.YELLOW1), (110, 230))
